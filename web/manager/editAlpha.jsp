...
<h:form>
    ...
    <h:panelGrid width="100%" style="text-align:center; margin-right:auto; margin-left:auto;" columns="3">
        ...
        <h:outputLabel id="hidden_username" value="#{userScrollerBean.currentAlpha.username}">

        </h:outputLabel>
        <rich:message for="hidden_username"/>

        <h:outputText value="Alphanumeric : "></h:outputText>
        <h:inputText id="org_alphanumeric" requiredMessage="Alphanumeric Required" required="true" value="#{userScrollerBean.currentAlpha.name}">
